...
//   const mainImage = images.length > 0 ? getImageUrl(images[0].src) : null;
...
//               currentFacade ? (
//                 <>
//                   <img src={getImageUrl(currentFacade.src)} alt={`Facade ${currentFacadeIdx + 1}`} className="w-full h-full object-cover rounded-xl" />
