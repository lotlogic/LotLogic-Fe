...
const AdminLoginPage = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-stone-50 text-[var(--color-ink)]">
      <div className="border-b border-stone-700 bg-brand-secondary px-4 py-4 md:px-8">
        <div className="mx-auto flex max-w-6xl items-center">
          <Link to="/" className="inline-flex items-center" aria-label={brand.title}>
            <img
      ...
      <main className="flex-1 bg-gradient-to-b from-stone-100 via-stone-50 to-white">
      ...
      <footer className="bg-brand-secondary px-4 py-10 text-white md:px-8">
