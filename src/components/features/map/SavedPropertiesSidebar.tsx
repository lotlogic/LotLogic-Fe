                            ...
                            <div key={property.id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-gray-600 mb-2">Single Storey</p>
                                        <div className="flex items-center gap-3 text-xs text-gray-700">
                                            ...
                                            <span className="flex items-center gap-1">
                                                ...
                                                {property.houseDesign.storeys}
                                            </span>
                                        </div>
                                    </div>
                                    <button
                                        onClick={() => onViewDetails(property)}
                                        className="bg-[#2F5D62] text-white px-3 py-2 rounded-lg text-sm font-medium hover:bg-[#1a3d42] transition-colors"
                                    >
                                        View Details
                                    </button>
                                </div>
