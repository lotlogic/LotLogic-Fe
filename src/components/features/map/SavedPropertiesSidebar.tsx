...
Omit<SavedPropertiesSidebarProps, "savedProperties">) => {
  ...
  const { savedProperties: storeSavedProperties, removeFromSaved } =
              ...
              {storeSavedProperties.map((property, index) => (
                ...
                >
                  ...
                  <div className="flex gap-4">
                    <img
                      src={
                        getImageUrl(property.houseDesign.floorPlanImage) ||
                        getImageUrl(property.houseDesign.images?.[0]?.src) ||
                        property.houseDesign.image
                      }
